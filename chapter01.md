...
| <img src="/assets/c01/Car.png" width="100" height="100"> <br>Carlos Alberto Gonzalez Custodio u202020230     | Soy estudiante de la carrera de Ingeniería de Software. Me encanta enriqueser mis conocimientos con nuevos desafios y tengo un gran interes por el desarrollo web. | Poseo conocimientos en los lenguajes de programación: C++, Python, Javacript, PHP y C#. Y de algunas bases de datos como MySQL, SQL Server y MongoDB|
| <img src="/assets/c01/CarlosA.jpg" width="100" height="100"> <br>Ario Joel Chavez Uribe u202213468  | Soy estudiante de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas (UPC). TMe considero una persona comprometida, organizada y con una gran capacidad para adaptarme a nuevos retos. Me apasiona crear soluciones tecnológicas innovadoras, y en cada proyecto busco aportar lo mejor de mí para resolver los problemas de forma efectiva y eficiente. | Tengo experiencia en desarrollo de software y programación en lenguajes como JavaScript, C++, Python y tecnologías modernas como Next.js y React.|                           |
| <img src="/assets/c01/Ario.png" width="100" height="100"> <br>Ario Joel Chavez Uribe u202213468     | Soy estudiante de la carrera de Ingeniería de Software. Tengo interés en aprender sobre nuevas tecnologías, el desarrollo web y de aplicaciones. | Poseo conocimientos en los lenguajes de programación: C++, Python, y Javacript. Útiles para el desarrollo y solución del proyecto.                                          |
...
- **Problem Statement 1: Acceso limitado a opciones accesibles de alquiler de vehículos**
    - Las soluciones actuales de alquiler de vehículos son costosas y poco flexibles, lo cual representa una barrera para los arrendatarios que buscan opciones de movilidad temporal más económicas.
...
- **Problem Statement 2: Dificultad para monetizar vehículos no utilizados por parte de los propietarios**
    - Muchos propietarios de vehículos no cuentan con herramientas eficientes para generar ingresos a partir de sus autos cuando no los utilizan.
...
- **Problem Statement 3: Escasez de modelos de negocio sin necesidad de flota propia**
    - Las empresas tradicionales de alquiler requieren grandes inversiones en flota, lo cual limita su escalabilidad y capacidad de innovación.
...
- **Problem Statement 4: Ausencia de una plataforma escalable y confiable que conecte oferta y demanda en tiempo real**
    - Actualmente no existe una solución integral que permita la conexión eficiente y segura entre propietarios y arrendatarios en un entorno de confianza mutua.
